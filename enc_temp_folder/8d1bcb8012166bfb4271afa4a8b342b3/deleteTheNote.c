...
int deleteTheNote(char *name) {
	...
	FILE *f; int i;
	fopenCorrectly(&f, name, "r+b"); //open and go to the begining of file //open file if it does not exist

	puts("Input the paramets of product you want to delete in the database");
